...
Off-Lattice. 
Lado de tablero L=10. Condición de contorno periódico. Densidades d=2, 4 y 8 (o sea, N = 200, 400 y 800). v = 0.03. rc=1. 0<=eta<2pi (en principio, cortar cuando se estabiliza en 0).
